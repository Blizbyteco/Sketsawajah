...
(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    $(
      ".overlay_menu .overlay_navmenu ul.main-menu li.menu-item-has-children"
    ).append(
      $(
        "<span class='submenu_opener'><i class='bi bi-chevron-right'></i></span>"
      )
    ...
    // Sub-Menu Open On-Click
    $(
      ".overlay_menu ul.main-menu li.menu-item-has-children .submenu_opener"
    ).on("click", function (e) {
      $(this).parent().toggleClass("nav_open");
      $(this).siblings("ul").slideToggle();
      e.stopPropagation();
    ...
    $(window).resize(function () {
      ...
      $(
        " .wptb-slider.style2 .swiper-container, .wptb-slider.style3 .swiper-container,.wptb-slider.style5 .swiper-container"
      ).height(height);
      $(
        ".wptb-slider.style2 .swiper-slide, .wptb-slider.style3 .swiper-slide, .wptb-slider.style5 .swiper-slide"
      ).height(height);
    ...
    // Slider Seven
    var SwiperSliderSevenThumbs = new Swiper(
      ".wptb-swiper-slider-seven-thumbs",
      {
        loop: true,
        autoplay: {
          delay: 3000,
    ...
    $(
      ".wptb-image-box1, .wptb-image-box2, .wptb-blog-grid1, .wptb-packages1, .wptb-icon-box2, .wptb-icon-box5, .wptb-icon-box7, .wptb-award-list .wptb-item, .wptb-features .wptb-item"
    )
      ...
      .on("mouseleave", function () {
        $(
          ".wptb-image-box1.highlight, .wptb-image-box2.highlight, .wptb-blog-grid1.highlight, .wptb-packages1.highlight, .wptb-icon-box2.highlight, .wptb-icon-box5.highlight, .wptb-icon-box7.highlight, .wptb-award-list .wptb-item.highlight, .wptb-features .wptb-item.highlight"
        ).addClass("active");
      });
